...
Usage: QUECOMBI_STATS_TOKEN=... python3 scripts/14_import_drafts.py [--slug X]
Writes data/geojson/field/<slug>.geojson for each draft and prints the
...
def main():
    ...
    print("  2. python3 scripts/06_build_map.py && 12_build_sponsors.py && 09_build_site.py")
