...
Usage:
  python3 scripts/19_generate_stickers.py --batch 2026-07-A --count 100 --outdir stickers

Output:
  stickers/<batch>/   # per-sticker PNGs (3×3 cm @ 300 DPI)
  stickers/<batch>/sheet_*.png  # A4 printable sheets (10 per page)
  stickers/<batch>/stickers.csv # D1 seed (import via wrangler d1 execute)
