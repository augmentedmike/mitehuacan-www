...
Examples:
  ...
  python3 apps/www/scripts/restore.py --file /tmp/snap.json.gz --target staging
  # a real disaster restore to prod is deliberate and loud:
  BACKUP_TOKEN=... python3 apps/www/scripts/restore.py --from-worker latest --target production --yes
