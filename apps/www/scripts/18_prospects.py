...
Usage:  python3 scripts/18_prospects.py [route-id ...]
Output: prospects/<route>.csv + prospects/_summary.csv
"""
import csv
import importlib
import json
...
def main():
    ...
    print(f"prospects: {total} route-adjacencies across {len(summary)} routes -> prospects/")
    for s in top:
