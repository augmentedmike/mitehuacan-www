...
network boundary bbox (+ pan margin), dedupes, and writes:
  - data/raw/osm/oxxo_raw.json          (raw Overpass response)
  - data/sponsors/oxxo_locations.json    (processed list)
  - data/sponsors/oxxo_locations.geojson (FeatureCollection of Points)
