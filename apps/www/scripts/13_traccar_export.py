...
Writes data/geojson/field/<slug>.geojson and prints the follow-up steps
...
def main():
    ...
    print("\nnext steps:")
    print(f"  1. add/update a row in data/master_route_index.csv:")
    print(f"     geometry_files = geojson/field/{args.slug}.geojson  · sources += field-ride")
    print(f"  2. rebuild: python3 scripts/06_build_map.py && 12_build_sponsors.py && 09_build_site.py")
